package br.com.coffeeandit.transactionbff.limite.feign;
...
public interface LimiteClient {
    ...
    LimiteDiario findLimiteDiario(@PathVariable("agencia") final Long agencia, @PathVariable("conta") final Long conta);
